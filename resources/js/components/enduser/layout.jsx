...
export default function Layout({ children, onProfileClick, onLogout }) {
  const { flash = {}, auth = null } = usePage().props;

  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <Header auth={auth} onProfileClick={onProfileClick} onLogout={onLogout} />
